#Transition Mapping LCM#######################################
#Jason Stein, Luis de la Torre Ubietta, Daniel Geschwind     #
#                                                            #
#                                                            #
#See instructions                                            #
##############################################################

cat("\n\nTransition Mapping BrainSpan Data\n");
cat(" by Jason Stein, Luis de la Torre Ubietta, Daniel Geschwind\n");
cat(" Modified for RNAseq by Aaron Gorodn\n")
cat("\n\n");
...
RRHO <- function(list1,list2,stepsize,labels,plots=FALSE,outputdir=NULL,annot=NULL) {
  ...
  if (plots) {
    ...
    ##mtext(paste("-log10(BY P-value) =",max(hypermat.by)),3,0.5,cex=0.5);
